import 'package:demo_catalog_app/modules/Product/repositories/groups_controller.dart';
          ...
          child: Column(
            children: [
              ...
              Container(
                child: InkWell(
                  onTap: () {
                    GroupsController.rename(1, "doggy");
                  },
                  child: Text("rename"),
                ),
              ),
