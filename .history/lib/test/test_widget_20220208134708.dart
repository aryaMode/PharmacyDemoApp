...
class _TestWidgetState extends ConsumerState<TestWidget> {
  late final locationIndex;
  late final tabIndex;
  late final asyncTabs;
  @override
  void initState() {
    super.initState();
    locationIndex = ref.watch(locationIndexProvider.state);
    tabIndex = ref.watch(tabIndexProvider.state);
    asyncTabs = ref.watch(tabsStreamProvider);
  ...
  Widget build(BuildContext context) {
    ...
    asyncTabs.when(
      data: (data) {
        final tabState = ref.watch(tabsProvider.state);
        tabState.state = data;
      },
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  child: Text("Get Data 1"),
                ),
              ),
              InkWell(
                onTap: () {},
                child: Container(
                  child: Text("Get Data 2"),
                ),
              ),
              InkWell(
                onTap: () {
