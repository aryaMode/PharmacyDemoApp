...
import 'package:demo_catalog_app/modules/Tabs/controllers/tab_controller.dart' as tab;
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  tab.TabController(reader: ref.read,index:0)
                      .rename(oldIndex: 1, newIndex: 4);
                },
                child: Container(
