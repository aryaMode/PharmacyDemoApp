...
final introImagesProvider = StreamProvider<SplayTreeMap<Img>?>((ref) {
  ...
  return stream.map(
    (DatabaseEvent event) {
      ...
      SplayTreeMap<String, dynamic> images = SplayTreeMap<String, Img>.from(
        dataMap['images'].map((key, value) => MapEntry(key, Img.fromMap(value))),
        (String a, String b) {
          return dataMap['images'][a]['index'] - dataMap['images'][b]['index'];
        },
      );
      return groups;
    },
