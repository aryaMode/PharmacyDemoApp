...
class _IntroductionPageState extends State<IntroductionPage> {
  ...
  Widget build(BuildContext context) {
    BottomNavButton skipButton = BottomNavButton(
      style:kMiniButtonOffsetAdjustment,
                  tileText: "Skip",
                  onPress: () {
          ...
          ScrollableImages(
            ...
            onPageChange: (val) {
              setState(() {
                ...
                if( !isLast(currentImageIndex,images.length)){
                    skipButton.copyWith(tileText: "Start", color: kSecondaryColor)
                }
              });
            },
            images: images,
