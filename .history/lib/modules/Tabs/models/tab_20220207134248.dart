...
class Tab {
  ...
  factory Tab.emptyTab({
    ...
    return Tab(
      index: index,
      locationFolders: SplayTreeMap<String, LocationFolders>.from(Locations
          .locations
          .asMap()
          .map((index, location) => MapEntry<String, LocationFolders>(
              Uuid().v4(), LocationFolders.emptyLocationFolders(location)))),
