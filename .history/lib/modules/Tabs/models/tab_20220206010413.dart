...
class Tab {
  ...
  factory Tab.emptyTab() {
    return Tab(
      index: 0,
      locationFolders: SplayTreeMap<String,LocationFolders>.from(Locations.locations.map((location)=>MapEntry<String,LocationFolders>(Uuid().v4(),LocationFolders.emptyLocationFolders(location)))),
      name: '',
    );
  }
  Tab copyWith({
