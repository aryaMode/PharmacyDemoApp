          ...
          children: [
            Column(
              children: [
                ...
                Flexible(
                  flex: 7,
                  child: FoldersViewBuilder(editable: editable),
                ),
              ],
            ),
            editable
...
class FoldersViewBuilder extends StatefulWidget {
  ...
  @override
  State<FoldersViewBuilder> createState() => _FoldersViewBuilderState();
}

class _FoldersViewBuilderState extends State<FoldersViewBuilder> {
  late List<Widget> folders;
  _initialization(bool editable){
    folders = [
      for (int i = 0; i < 4; i++)
        Draggable(
          childWhenDragging: SizedBox.shrink(),
