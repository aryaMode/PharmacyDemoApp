...
final folders = StateProvider.autoDispose<List<Folder>>(
  (ref) {
    final index = ref.watch(selectedTabIndicesProvider);
    return ref.watch(tabsProvider).elementAt(index).locationFolders.values.where((locationFolders) => locationFolders.location == Locations.locations[ref.watch(locationIndexProvider)]
  },
);
