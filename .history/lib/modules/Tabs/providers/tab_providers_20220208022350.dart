...
final folders = StateProvider.autoDispose<List<Folder>>(
  (ref) {
    ...
    return ref.watch(tabsProvider).elementAt(index).locationFolders.values.where((locationFolders) => locationFolders.location == Locations.location[ref.watch(locationIndexProvider)
  },
);
