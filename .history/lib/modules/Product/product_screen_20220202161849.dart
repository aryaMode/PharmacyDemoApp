          ...
          children: [
            Column(
              children: [
                ...
                ProductPageView(pageController: pageController, productSliderTiles: productSliderTiles, editable: editable),
              ],
            ),
          ],
        );
...
class ProductPageView extends StatelessWidget {
  const ProductPageView({
    ...
    required this.productSliderTiles,
    required this.editable,
  }) : super(key: key);

  final PageController pageController;
  final List<ProductsliderTile> productSliderTiles;
  final bool editable;
