      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          ref.watch(editableProvider)
              ? Visibility(child: buildReorderIcon(context))
              : SizedBox.shrink(),
          EditIcon(
              ...
              builder: (context) => DialogBox(
                    child: ReorderableLayout(
                      ...
                      onReorder: (int oldIndex, int newIndex) {
                        ...
                        GroupController(
                                index: ref
                                    .read(selectedGroupsIndicesProvider))
    ...
    groupTabs = groups.map(
      (group) {
        return FillOutlineButton(
          press: () {
            ref.refresh(pageIndexProvider);
            ref.read(selectedGroupsIndicesProvider.state).state = groups.indexOf(group);
          },
          text: group.name,
        ...
        widget.editable
            ? Positioned(
                ...
                child: Padding(
                  ...
                  child: Visibility(
                    visible: ref.read(selectedGroupsIndicesProvider) != -1,
                    child: AddRemoveIconRow(
                      ...
                      onAdd: () {
                        GroupController(
                            ...
                            .addProduct(ref.read(pageIndexProvider));
                        ref
                            .read(selectedGroupsIndicesProvider.state)
