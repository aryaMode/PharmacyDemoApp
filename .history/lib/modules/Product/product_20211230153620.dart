...
class _ProductState extends State<Product> {
  ...
  Row buildAddRemoveIconRow({dynamic Function()? onAdd, dynamic Function()? onDelete, double inheritedPadding = 0,required int listLength,}) {
    return Row(
