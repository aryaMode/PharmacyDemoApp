    ...
    return Scaffold(
      ...
      body: SafeArea(
        child:futureGroups.when(
            data: (groups) {
              return ProductScreenBuilder(groups);
            },
...
class ProductScreenBuilder extends ConsumerStatefulWidget {
  ...
  const ProductScreenBuilder({this.groupKey? key }) : super(key: key);
...
class ProductScreenBuilder extends ConsumerStatefulWidget {
  ...
  const ProductScreenBuilder(this.groups, {Key? key}) : super(key: key);
  _initialization() {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ProviderScope(
      overrides: [productsProvider.overrideWithValue((groups.expand((group) => group.products)).toList())],
      child: Stack(
        children: [
          Column(
            children: [
