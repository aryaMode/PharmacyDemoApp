...
class LocationImage {
  ...
  factory LocationImage.emptyLocationImage(String location) {
    return LocationImage(location: lo);
  }
  ...
  factory LocationImage.fromJson(String source) =>
      LocationImage.fromMap(json.decode(source));
