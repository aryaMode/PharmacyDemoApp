...
final selectedGroupIndexProvider = StateProvider.autoDispose<int>((ref) => -1);

final productsProvider = StateProvider.autoDispose<List<Product>>(
  (ref) {
    final groups = ref.watch(groupsProvider);
    final selectedGroupIndices = ref.watch(selectedGroupIndexProvider);
    return groups
...
final pageControllerProvider = Provider.autoDispose<PageController>((ref) => PageController())
