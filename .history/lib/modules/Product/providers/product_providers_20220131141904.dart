...
final selectedTabsIndicesProvider =
    StateProvider.autoDispose<List<int>>((throw UnimplementedError()));
...
final productsProvider = Provider<List<Product>?>(
  (ref) {
    ...
    List<int> groupIndices = ref.watch(selectedTabsIndicesProvider);
    return groups
