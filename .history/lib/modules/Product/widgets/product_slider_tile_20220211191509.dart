      ...
      children: [
        ...
        Visibility(
          visible: ref.watch(editableProvider) ||
              ref.watch(productProvider).priceList.values
                      .elementAt(ref.watch(locationIndexProvider))
                      .image
                      ?.url !=
                  null,
        ...
        Visibility(
          visible: ref.watch(editableProvider) || ref.watch(productProvider).offer?.url != null,
          child: BottomNavButton(
            tileText: "offer",
            padding: EdgeInsets.all(15),
            onPress: () {
        ...
        Visibility(
          visible: ref.watch(editableProvider) || ref.watch(productProvider).other?.url != null,
          child: BottomNavButton(
            tileText: "other",
            padding: EdgeInsets.all(15),
            onPress: () {
