...
class ProductsliderTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    Product? product = ref.watch(productProvider(productIndex));
    return Container(
      child: Row(
        children: [
          Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              Expanded(
                                flex: 1,
                                child: Container(
                                  child: ref.watch(editableProvider)?ImagePicker(image: product?.logo):ImageWidget(image:product?.logo),
                                ),
                              ),
                            ],
                          ),
