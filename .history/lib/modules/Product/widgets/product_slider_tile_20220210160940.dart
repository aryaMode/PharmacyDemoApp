                    ...
                    child: Stack(
                      children: [
                        ref.watch(editableProvider)
                            ? ImagePicker(
                                image: product.priceList.values.elementAt(

                                 ref.read(locationIndexProvider)
                                ).image,
                                onTap: (pickedFile) async {
                                  ProductController(id: product.id)
                                      .setPriceListImage(pickedFile, ref.read);
                                },
                              )
                            : ImageWidget(image: product.priceList.values.elementAt(

                                 ref.watch(locationIndexProvider)).image),
                        Align(
                          ...
                          child: Container(
                            ...
                            child: DropDown(
                              ...
                              value: Locations
                                  .locations[ref.watch(locationIndexProvider)],
