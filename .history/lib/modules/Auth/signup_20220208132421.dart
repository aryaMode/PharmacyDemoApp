...
class AuthPageTemplate extends ConsumerStatefulWidget {
  const AuthPageTemplate({Key? key}) : super(key: key);

  @override
  ConsumerState<AuthPageTemplate> createState() => _SignUpState();
}

class _SignUpState extends ConsumerState<AuthPageTemplate> {
  @override
        ...
        AuthButton(
            ...
            onTap: () async {
              ...
              var currentUser = (await AuthServices()
                  .getCurrentUserInfo(uid: AuthServices.auth.currentUser!.uid));
