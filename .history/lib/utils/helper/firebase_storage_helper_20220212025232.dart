...
Future<void> preCacheImageFiles() async {
  firebase_storage.ListResult result =
      await firebase_storage.FirebaseStorage.instance.ref("images").listAll();

  for (firebase_storage.Reference ref in result.items) {
    FirebaseImage("gs://pharmacycatalogdemo.appspot.com/${ref.fullPath}",maxSizeBytes: 4000000,cacheRefreshStrategy: CacheRefreshStrategy.BY_METADATA_DATE)
        .preCache();
  }
}
