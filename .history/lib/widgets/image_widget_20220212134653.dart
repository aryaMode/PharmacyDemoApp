            ...
            image: DecorationImage(
              ...
              image: (widget.image != null
                  ? (widget.image!.url != null
                      ...
                      ? !kIsWeb?(FirebaseImage(
                          "gs://pharmacycatalogdemo.appspot.com/images/${widget.image!.name}",
                          maxSizeBytes: 4000000)
                      :Image.network(widget.image!.url!).image)
                      : Image.asset(widget.image!.assetPath ?? kUploadImage)
                          .image)
                  : Image.asset(kUploadImage).image),
            ),
          ),
        ),
      ),
