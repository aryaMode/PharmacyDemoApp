...
class CustomTabs extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    int crossAxisCount = filledOutlineButtonList.length + (footer.length);
    crossAxisCount = crossAxisCount == 0? 1:cr;
    return Container(
      color: kPrimaryColor,
      ...
      child: ReorderableLayout(
        ...
        crossAxisCount: (filledOutlineButtonList.length + (footer.length)) != 0,
