...
class Folder extends ConsumerWidget {
  ...
  Folder copyWith({
    ...
    return Folder(
      ...
      backgroundImage:text ?? this.text,
      backgroundImage:editable ?? this.editable,
      backgroundImage:textColor ?? this.textColor,
      backgroundImage:onFieldSubmitted ?? this.onFieldSubmitted,
      backgroundImage:onPress ?? this.onPress,
    );
  }
}
